...
import { setOptionItem, setOptionNotifier, showOptionManager } from "./option.reducer"
import { useDeleteOptionMutation } from "./option.services"
...
const OptionRecords = () => {
    ...
    const toggleEdit = (item) => {
        dispatch(setOptionItem(item))
        dispatch(showOptionManager())
    }

    const toggleDelete = (item) => {
        assignDeleteCallback({ item: item, callback: handleDelete })
        dispatch(showDelete({ description: "Option", reference: item.name }))
    }
