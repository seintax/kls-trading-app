        ...
        return [
            {
                value:
                    <div className="flex gap-1 flex-wrap">
                        ...
                        <span className={`${item.variant_serial ? "" : "hidden"} bg-gray-300 px-1 rounded-md border border-gray-400`}>
                            {item.variant_serial}
                        </span>
                        <span className={`${item.variant_model ? "" : "hidden"} bg-gray-300 px-1 rounded-md border border-gray-400`}>
                            {item.variant_model}
                        </span>
                        <span className={`${item.variant_brand ? "" : "hidden"} bg-gray-300 px-1 rounded-md border border-gray-400`}>
                            {item.variant_brand}
                        </span>
                    </div>
            },
