...
import { resetInventoryShown, setInventoryDisplay } from "../inventory/inventory.reducer"

const CasheringComplexInventory = () => {
    const dataSelector = useSelector(state => state.inventory)
    const dispatch = useDispatch()

    const toggleOff = () => {
        dispatch(setInventoryDisplay(true))
...
export default CasheringComplexInventory