...
import CreditIndex from "../credit/credit.index"
import { resetCreditShown, setCreditDisplay } from "../credit/credit.reducer"

const CasheringComplexCredits = () => {
    const dataSelector = useSelector(state => state.credit)
    const dispatch = useDispatch()

    const toggleOff = () => {
        dispatch(setCreditDisplay(true))
...
export default CasheringComplexCredits