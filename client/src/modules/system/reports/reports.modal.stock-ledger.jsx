...
const ReportsModalStockLedger = () => {
    ...
    useEffect(() => {
        const consolidatedData = [...injectType(returnedrecord, "Return"), ...injectType(adjustmentrecord, "Adjustment"), ...injectType(dispensingrecord, "Dispensing"), ...injectType(transmitrecord, "Transfer")]
