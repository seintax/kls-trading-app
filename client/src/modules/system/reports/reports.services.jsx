...
export const reportsApiSlice = apiSlice.injectEndpoints({
    endpoints: (builder) => ({
        ...
        inventoryReport: builder.mutation({
            query: (params) => ({
                url: `${ENDPOINT_URL}/inventoryreport`,
                method: 'GET',
                params
            }),
            providesTags: ['reports']
        }),
        stockAlertReport: builder.mutation({
            query: (params) => ({
                url: `${ENDPOINT_URL}/stockalert`,
                method: 'GET',
                params
            }),
            providesTags: ['reports']
        }),
        stockAdjustmentReport: builder.mutation({
            query: (params) => ({
                url: `${ENDPOINT_URL}/stockadjustment`,
                method: 'GET',
                params
            }),
            providesTags: ['reports']
...
export const {
    ...
    useStockAlertReportMutation,
    useStockAdjustmentReportMutation,
} = reportsApiSlice